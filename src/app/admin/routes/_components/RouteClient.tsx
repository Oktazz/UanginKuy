...
export default function RouteClient({
  ...
  const handleGenerate = async () => {
    ...
    } else if (result?.error === "NO_ASSIGNED_COURIERS") {
      setFeedback({
        kind: "error",
        message:
          "Belum ada kurir yang ditugaskan ke timbangan IoT. Silakan pasangkan perangkat timbangan pada panel armada IoT terlebih dahulu.",
      });
