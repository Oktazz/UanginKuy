...
export default async function CourierProfile() {
  ...
  return (
    <div className="space-y-6 pb-4">
      {/* Page Header */}
      <header>
        <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Profil Kurir</h2>
        <p className="text-sm text-gray-500 mt-1">Kelola informasi akun kemitraan Anda.</p>
      </header>
